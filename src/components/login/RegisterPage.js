...
function RegisterPage(props) {
    ...
    return (
        <div className="register-page">
            ...
            <form action="/api/auth/register_process" method="POST" className='register-box'>
                ...
                <div className="inputs">
                    <input className="id-input" type="text" name="userNm" placeholder="이름" required />
                </div>
                ...
                <div className="inputs">
                    <input type="password" name='userPwChk' placeholder='비밀번호 확인' required style={{ top: "32px" }} />
                </div>
