...
function BoardModal(props) {
    const [modifyCont, setModifyCont] = useState(props.pageBoardList[props.boModalNum].BO_CONT)
    const [modifyTitle, setmodifyTitle] = useState(props.pageBoardList[props.boModalNum].BO_TITLE)
            ...
            props.setShowModal(false)
                ...
                <div className="announce-num" onClick={function(e) {
                    ...
                    <h5 style={{
                        ...
                        paddingLeft: "50px",
                        height: "40px"
                    }}>작성자 : {props.pageBoardList[props.boModalNum].REGR_ID}</h5>
                    ...
                    <div style={{
                        ...
                        <p className="regr-dttm" style={{
                            ...
                            작성일 : {props.pageBoardList[props.boModalNum].REGR_DTTM}
                        </p>
                                ...
                                <Button variant='danger' style={{
                                    ...
                                    onClick={function () {
                                        axios.post("/api/board/delete", {
                                            postNumber: props.pageBoardList[props.boModalNum].BO_ID
                                        }
                                ...
                                >삭제</Button>
                                {
                                    isModify
                                        ...
                                        <Button variant='primary' style={{
                                            ...
                                            onClick={function () {
                                                axios.post('/api/board/modify', {
                                                    modifyTitle: modifyTitle
                                                    , modifyCont: modifyCont
                                                    , modifyNum: props.pageBoardList[props.boModalNum].BO_ID
                                                }).then(function (result) {
                                                    setIsModify(false)
